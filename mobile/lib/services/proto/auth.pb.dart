...
class RegisterEntryRequest extends $pb.GeneratedMessage {
  ...
  factory RegisterEntryRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RegisterEntryRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RegisterEntryRequest',
  ...
  RegisterEntryRequest clone() =>
      RegisterEntryRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RegisterEntryRequest copyWith(void Function(RegisterEntryRequest) updates) =>
      super.copyWith((message) => updates(message as RegisterEntryRequest))
          as RegisterEntryRequest;
  ...
  static $pb.PbList<RegisterEntryRequest> createRepeated() =>
      $pb.PbList<RegisterEntryRequest>();
  @$core.pragma('dart2js:noInline')
  static RegisterEntryRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RegisterEntryRequest>(create);
  static RegisterEntryRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get carPlate => $_getSZ(0);
  @$pb.TagNumber(1)
  set carPlate($core.String v) {
    $_setString(0, v);
  }
...
class LoginEntryRequest extends $pb.GeneratedMessage {
  ...
  factory LoginEntryRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LoginEntryRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LoginEntryRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'carPlate', protoName: 'carPlate')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LoginEntryRequest copyWith(void Function(LoginEntryRequest) updates) =>
      super.copyWith((message) => updates(message as LoginEntryRequest))
          as LoginEntryRequest;
  ...
  static $pb.PbList<LoginEntryRequest> createRepeated() =>
      $pb.PbList<LoginEntryRequest>();
  @$core.pragma('dart2js:noInline')
  static LoginEntryRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LoginEntryRequest>(create);
